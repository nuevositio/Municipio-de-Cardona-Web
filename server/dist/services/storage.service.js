 ...
 */
export async function uploadImage(buffer, originalName, mimeType, size) {
 ...
 * Valida MIME type y tamaño antes de enviar.
 */
export async function uploadDocument(buffer, originalName, mimeType, size) {
 ...
 */
export async function getSignedUrl(bucket, storagePath, expiresInSeconds = 3600) {
