...
export async function listMinutesController(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function getMinuteController(
  ...
  try {
    ...
    if (!item) throw new AppError(404, 'Acta no encontrada.')
...
export async function createMinuteController(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
...
export async function updateMinuteController(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    ...
    if (!existing) throw new AppError(404, 'Acta no encontrada.')
    ...
    const updateInput: Parameters<typeof updateMinute>[1] = {
      ...restData,
      updatedBy: actor.id,
    }
    ...
    if (!updated) throw new AppError(404, 'Acta no encontrada.')
...
export async function deleteMinuteController(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
